        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            >
              ...
              <div className="text-xs font-mono font-bold text-teal-700 dark:text-teal-400">11,67 € / mj.</div>
            </button>
            ...
            >
              <div className="absolute top-3 right-3 bg-gradient-to-r from-teal-600 to-teal-700 text-white text-[10px] font-mono font-bold px-2 py-0.5 rounded-full shadow-sm">
                Preporučeno
              </div>
              <div className="text-sm font-bold text-slate-900 dark:text-white mb-1">
              ...
              <div className="text-xs font-mono font-bold text-teal-700 dark:text-teal-400">23,33 € / mj.</div>
            </button>
          </div>
        </div>
        ...
        <div className="space-y-3 pt-2 border-t border-slate-100 dark:border-slate-800">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <label className={`flex items-start gap-3 p-4 rounded-2xl border transition-all cursor-pointer ${
              ...
              <div className="space-y-0.5">
                ...
                <p className="text-[11px] text-slate-500 dark:text-slate-400">
                  Pokriva doplate za recepte i lijekove s dopunske liste HZZO-a
                </p>
              </div>
            </label>
            ...
            <label className={`flex items-start gap-3 p-4 rounded-2xl border transition-all cursor-pointer ${
              ...
              <div className="space-y-0.5">
                <span className="text-xs font-bold text-slate-900 dark:text-white flex items-center gap-1.5">
                  <ShieldPlus className="w-3.5 h-3.5 text-teal-600 dark:text-teal-400" />
