...
export const CookieConsent: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-4 left-4 right-4 sm:left-6 sm:max-w-md z-50 bg-[#0a0d16]/95 backdrop-blur-xl rounded-3xl p-5 border border-white/[0.1] shadow-2xl text-xs space-y-3 animate-in slide-in-from-bottom-5 duration-300 text-slate-200">
      <div className="flex items-start justify-between gap-3">
        <div className="flex items-center gap-2 font-mono font-bold text-white">
          <ShieldCheck className="w-4 h-4 text-[#ff7b1a]" />
      ...
      <div className="flex items-center gap-2 pt-1 font-mono">
        <Button variant="primary" size="sm" onClick={handleAccept} className="w-full font-bold">
